...
function HeroSection() {
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center text-center bg-navy overflow-hidden">

      {/* HERO IMAGE (FIXED FOR MOBILE + DESKTOP) */}
      ...
      {/* TEXT CONTENT (MOBILE POSITION FIXED) */}
      <motion.div
        initial={{ opacity: 0, y: 40 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 3}}
        className="
          relative z-10 max-w-3xl px-4 sm:px-6 flex flex-col items-center text-center
          -mt-16 sm:mt-0
        "
      >
